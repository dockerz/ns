<section class="actions">
	<div class="container">
		...
		<form action="issues.php" method="get" accept-charset="utf-8" name="add_issue" class="halt">issue #: <input name="issue_number" type="text" value="<?php echo $new_issue; ?>" disabled /><button type="button">add</button></form>
